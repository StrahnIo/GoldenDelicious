...
#[cfg(feature = "fuji")]
use fuji::{FujiAffine, FujiField, FujiCurve, FujiPoint};
...
impl<C: CurveAffine> Clone for Params<C> {
    fn clone(&self) -> Self {
        Params {
            ...
            u: self.u,
            #[cfg(feature = "fuji")]
            fuji_srs: None, // SRS context can't be cloned; precomputed again on first use
        }
    }
}
...
#[cfg(feature = "fuji")]
fn bytes_to_repr<S: ff::PrimeField>(bytes: &[u8; 32]) -> S::Repr {
